...
const ECOSYSTEM = [
  ...
  },
  {
    ...
    alt: "A speaker presenting the evolution of money on stage at a U-TOPIA event",
  },
  {
                ...
                >
                  ...
                  <div className="p-7">
                    <div className="flex items-center justify-between">
                      ...
                      {tier.popular ? (
                        <span className="bg-brand-gradient rounded-full px-3 py-1 text-[10px] font-bold uppercase tracking-[0.18em] text-primary-foreground">
                          Most Popular
                        </span>
                      ) : (
